...
@section('body')
          <div class='container'>
            <div class='row card-panel z-depth-0 card-panel'>
            ...
            @foreach ($cardPublications as $cardPublication)
               <div class='col l4 m6 s12 animated-card '>
                  <div class='card medium hoverable col s12'>
                    <div class='card-image waves-effect waves-block waves-light'>
                        <img class='activator' src='{{$cardPublication->pathImagePreview}}'>
                    </div>
                    <div class='card-content'>
                        <span class='card-title activator grey-text text-darken-4'>{{ $cardPublication->title }} <br/>
                        <label>{{ $cardPublication->release_date }} </label>
                        <i class='material-icons right'>more_vert</i></span>
                        <p><a href='/portafolio/{{ $cardPublication->id }}'>Ver más</a></p>
                    </div>
                    <div class='card-reveal'>
                        <span class='card-title grey-text text-darken-4'>{{ $cardPublication->title }} <br/>
